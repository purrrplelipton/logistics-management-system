  ...
  (
    ...
    const endElement = showToggle ? (
      <button
        type="button"
        className={cn(
          'grid place-items-center p-1 text-gray-400 transition-colors hover:text-gray-600 focus:text-gray-600 focus:outline-none',
              ...
              {[...Array(3)].map((_, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    i < activeSegments ? getStrengthColor(strengthInfo.strength) : 'bg-gray-200',
                  )}
                />
              ))}
            </div>
            ...
            <div className="flex justify-center">
              <span
                className={cn(
                  ...
                  getStrengthTextColor(strengthInfo.strength),
                )}
              >
