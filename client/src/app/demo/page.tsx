...
const mockDeliveries = [
  {
    ...
    packageDetails: { description: 'Electronics package' },
    status: 'Pending',
    driverId: null,
  ...
  },
  {
    ...
    packageDetails: { description: 'Documents' },
    status: 'InTransit',
    driverId: { name: 'John Doe' },
    createdAt: new Date().toISOString()
  }
];
...
export default function CustomerDashboardDemo() {
  ...
  const stats = {
    ...
    inTransitDeliveries: mockDeliveries.filter(d => d.status === 'InTransit').length,
    completedDeliveries: mockDeliveries.filter(d => d.status === 'Delivered').length,
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert('Demo: Delivery request created successfully!');
    }, 1000);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Icon icon={truckIcon} className="h-8 w-8" />
              <span className="ml-2 font-bold text-xl">LogiTrack</span>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm">Demo Customer Dashboard</span>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="px-4 sm:px-0">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mt-1">
              Welcome! This is a demo showing the modal implementation for creating deliveries.
            </p>
          </div>
